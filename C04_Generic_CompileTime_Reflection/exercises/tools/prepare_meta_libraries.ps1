...
$RunEvidenceDir = Join-Path $EvidenceDir "dependencies-meta-$Stamp"
...
$dependencies = @(
    (Initialize-PinnedRepo -Name 'mp11' -PrefixName 'mp11-boost-1.91.0' -RepoUrl 'https://github.com/boostorg/mp11.git' -Commit 'b94b089d4ec83cd397f20958f34edf25bc3e06f4' -Headers @('include\boost\mp11.hpp', 'include\boost\mp11\map.hpp') -LicenseCandidates @('LICENSE_1_0.txt', 'LICENSE', 'README.md')),
    (Initialize-PinnedRepo -Name 'hana' -PrefixName 'hana-boost-1.91.0' -RepoUrl 'https://github.com/boostorg/hana.git' -Commit 'bc49ee25638e59d977edff5737b4e6bf12c1e5ea' -Headers @('include\boost\hana.hpp', 'include\boost\hana\map.hpp') -LicenseCandidates @('LICENSE_1_0.txt', 'LICENSE.md', 'LICENSE'))
)
