...
模式：`full`。记录时间：`2026-09-09T16:28:53.922335+00:00`。随机种子：`40412025`。
...
| 项数 | 版本 | 有效样本秒 | 中位数 | 范围 |
|---:|---|---|---:|---|
| 32 | recursive | 0.0930, 0.1100, 0.1250, 0.1250, 0.0940 | 0.1100 | 0.0930-0.1250 |
| 32 | fold | 0.1090, 0.0940, 0.1100, 0.0940, 0.1410 | 0.1090 | 0.0940-0.1410 |
| 128 | recursive | 0.1250, 0.1090, 0.1090, 0.1090, 0.1250 | 0.1090 | 0.1090-0.1250 |
| 128 | fold | 0.1100, 0.0940, 0.1090, 0.1100, 0.1090 | 0.1090 | 0.0940-0.1100 |
| 256 | recursive | 0.1400, 0.1560, 0.1720, 0.1560, 0.1720 | 0.1560 | 0.1400-0.1720 |
| 256 | fold | 0.1090, 0.0940, 0.0940, 0.1400, 0.1090 | 0.1090 | 0.0940-0.1400 |

## 类型查询 trace 定位

| 项数 | 版本 | Total Frontend us | Total InstantiateClass count | Total InstantiateFunction count |
|---:|---|---:|---:|---:|
| 32 | recursive | 21598 | 6 | 4 |
| 32 | fold | 20959 | 3 | 4 |
| 128 | recursive | 40944 | 6 | 4 |
| 128 | fold | 21826 | 3 | 4 |
| 256 | recursive | 74984 | 6 | 4 |
| 256 | fold | 23503 | 3 | 4 |
...
| 版本 | 有效样本秒 | 中位数 | 范围 |
|---|---|---:|---|
| implicit | 0.3740, 0.3900, 0.2650, 0.2810, 0.3440 | 0.3440 | 0.2650-0.3900 |
| explicit | 0.4690, 0.3920, 0.4060, 0.4070, 0.3750 | 0.4060 | 0.3750-0.4690 |
