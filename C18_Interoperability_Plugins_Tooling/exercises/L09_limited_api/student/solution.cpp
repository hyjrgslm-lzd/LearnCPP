...
static PyObject* abi_tag(PyObject*, PyObject*) { return PyUnicode_FromString("student"); }
static PyObject* transform(PyObject*, PyObject*) {
  PyErr_SetString(PyExc_NotImplementedError, "finish Limited API transform");
  return nullptr;
}
