...
function(cs_add_exercise name kind)
    ...
    if(BUILD_TESTING AND CONCURRENCY_STUDY_TEST_STARTERS)
        ...
        set_tests_properties(${name}_${_cs_role} PROPERTIES TIMEOUT 30 LABELS "${_cs_role}" SKIP_RETURN_CODE 77)
    endif()
    ...
    if(CONCURRENCY_STUDY_BUILD_REFERENCE AND _cs_reference)
        ...
        if(BUILD_TESTING)
            ...
            set_tests_properties(${name}_reference PROPERTIES TIMEOUT 30 SKIP_RETURN_CODE 77 LABELS "reference")
        endif()
    endif()
endfunction()
