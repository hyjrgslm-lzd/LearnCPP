...
所有主动编辑均在 Concurrency_Study 内。未修改任何 CMake、根 README、公共 benchmark 工具、标准/覆盖/质量索引、queue_baseline.hpp 或已审批的 01-mutex-baseline.md；未提交 git。共享工作树中其他作者的 CMake 和回收头修改保留原样。
