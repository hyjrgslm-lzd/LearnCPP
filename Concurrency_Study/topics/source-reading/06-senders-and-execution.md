...
先读 [任务组合桥接](../scheduling/03-execution-bridge.md)，真实课程使用点在 [M2 Reference](../../exercises/M2_execution_bridge/solution.cpp)。该练习已有的运行记录属于它自己的具体版本与配置，本篇只增加源码链的解释。完整自定义 sender/domain 教程仍由相邻 Execution_Study 承担，不在这里手写生产线程池。
