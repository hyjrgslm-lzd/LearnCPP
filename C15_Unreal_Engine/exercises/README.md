# C15_Unreal_Engine 习题集

> 对应教材: [../README.md](../README.md) (P:/C++Code/C15_Unreal_Engine 根目录)
>
> 风格参考: [P:/C++Code/C06_Ranges/exercises](../../C06_Ranges/exercises), [P:/C++Code/C10_Execution/exercises](../../C10_Execution/exercises)

本目录是 C15_Unreal_Engine 教材的**可动手配套习题**。每题是一个独立 UE 游戏 runtime module, 以 `ExXN_Topic/` 命名 (X = 模块字母, N = 题号)。共 **36 习题 + 2 结课项目 = 38 独立模块**。

---

## 定位

教材 (`P:/C++Code/C15_Unreal_Engine/*.md`) 专注**文字讲义 + 内嵌片段**; 本目录专注**可编译骨架 + TODO 填空 + 验证观察点**。
