// C15_Unreal_Engine 习题集 Editor Target
// 对应教材: P:/C++Code/C15_Unreal_Engine/README.md

using UnrealBuildTool;
using System.Collections.Generic;

public class C15_Unreal_EngineEditorTarget : TargetRules
{
	public C15_Unreal_EngineEditorTarget(TargetInfo Target) : base(Target)
	{
