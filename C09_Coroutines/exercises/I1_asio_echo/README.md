...
```powershell
cmake -S C09_Coroutines/exercises -B build/coroutine-i1 -DCOROUTINE_STUDY_ENABLE_ASIO=ON -DCOROUTINE_STUDY_FETCH_DEPS=ON -DCOROUTINE_STUDY_BUILD_REFERENCE=ON
