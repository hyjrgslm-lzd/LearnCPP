...
```text
C09_Coroutines/exercises/Capstone5_mini_corolib/include/mini
C09_Coroutines/exercises/Capstone5_mini_corolib/src
C09_Coroutines/exercises/Capstone5_mini_corolib/tests
```

Reference 位于：

```text
C09_Coroutines/exercises/Capstone5_mini_corolib/reference
```
