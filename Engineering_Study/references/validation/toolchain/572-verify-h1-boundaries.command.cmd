...
set BUILD=%ROOT%\Engineering_Study\exercises\build\verify-h1-r4-boundaries
set NEGOUT=%ROOT%\Engineering_Study\references\validation\toolchain\572-h1-hidden-type-negative.stdout.txt
set NEGERR=%ROOT%\Engineering_Study\references\validation\toolchain\572-h1-hidden-type-negative.stderr.txt
...
findstr /i /c:"hidden_state" "%NEGERR%" >nul
if errorlevel 1 findstr /i /c:"hidden_state" "%NEGOUT%" >nul
