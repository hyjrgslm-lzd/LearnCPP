...
"%PYTHON%" "%ROOT%\Engineering_Study\exercises\G1_diagnostics\scripts\verify_fuzz.py" --clang "%CLANG%" --output "%ROOT%\Engineering_Study\references\validation\toolchain\g1-r6-fuzz-after-safe-starter"
exit /b %errorlevel%
