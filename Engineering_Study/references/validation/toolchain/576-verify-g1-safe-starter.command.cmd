...
set BASE=%ROOT%\Engineering_Study\references\validation\toolchain\g1-safe-starter-r1
...
:check_one
set CONFIG=%1
set BUILD=%ROOT%\Engineering_Study\exercises\build\g1-safe-starter-r1-%CONFIG%
...
echo %STUDENT_EXIT%> "%BASE%\%CONFIG%-student.exit.txt"
