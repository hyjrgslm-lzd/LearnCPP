...
```powershell
cmake -S Engineering_Study/exercises/F1_cmake_targets -B Engineering_Study/exercises/build/learner-f1 -G Ninja -DCMAKE_BUILD_TYPE=Release
cmake --build Engineering_Study/exercises/build/learner-f1 --verbose
ctest --test-dir Engineering_Study/exercises/build/learner-f1 --output-on-failure
```
...
```powershell
cmake -S Engineering_Study/exercises/F1_cmake_targets -B Engineering_Study/exercises/build/learner-f1-student -G Ninja -DCMAKE_BUILD_TYPE=Release -DENGINEERING_STUDY_TEST_STUDENTS=ON
cmake --build Engineering_Study/exercises/build/learner-f1-student --verbose
ctest --test-dir Engineering_Study/exercises/build/learner-f1-student -L student --output-on-failure
```
