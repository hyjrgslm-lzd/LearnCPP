...
```powershell
cmake -S Engineering_Study/exercises/G1_diagnostics -B Engineering_Study/exercises/build/learner-g1 -G Ninja -DCMAKE_BUILD_TYPE=Release -DENGINEERING_STUDY_TEST_STUDENTS=ON
cmake --build Engineering_Study/exercises/build/learner-g1
ctest --test-dir Engineering_Study/exercises/build/learner-g1 -L reference --output-on-failure
ctest --test-dir Engineering_Study/exercises/build/learner-g1 -L student --output-on-failure
```
...
& $StudyPython --version
& $StudyClang --version
& $StudyPython Engineering_Study/exercises/G1_diagnostics/scripts/verify_fuzz.py --clang $StudyClang --output Engineering_Study/exercises/build/learner-g1-fuzz-001
```
