...
def copy_fixture(repo: Path, destination: Path) -> Path:
    exercises_src = repo / "Engineering_Study" / "exercises"
    exercises_dst = destination / "Engineering_Study" / "exercises"
...
def self_test() -> int:
    scratch_parent = Path.cwd() / "Engineering_Study" / "exercises" / "build"
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        ...
        "fixture_source_sha256": digest_tree(repo / "Engineering_Study" / "exercises" / "G2_build_cost"),
        "process_runner_sha256": digest_file(repo / "Engineering_Study" / "exercises" / "tools" / "process_runner.py"),
        "schedule": schedule,
        "rounds": [],
        "summary": [],
    }
