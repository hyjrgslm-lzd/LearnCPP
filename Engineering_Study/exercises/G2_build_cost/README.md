...
```powershell
cmake -S Engineering_Study/exercises/G2_build_cost -B Engineering_Study/exercises/build/learner-g2 -G Ninja -DCMAKE_BUILD_TYPE=Release
cmake --build Engineering_Study/exercises/build/learner-g2 --verbose
ctest --test-dir Engineering_Study/exercises/build/learner-g2 --output-on-failure
```
...
& $StudyPython Engineering_Study/exercises/G2_build_cost/scripts/measure_build.py --self-test
& $StudyPython Engineering_Study/exercises/G2_build_cost/scripts/measure_build.py --output Engineering_Study/exercises/build/learner-g2-smoke-report --work-root Engineering_Study/exercises/build/learner-g2-smoke-work --cmake $StudyCMake --ninja $StudyNinja --samples 1 --warmups 1 --variant baseline --scenario noop
```
...
```powershell
& $StudyPython Engineering_Study/exercises/G2_build_cost/scripts/measure_build.py --output Engineering_Study/exercises/build/learner-g2-formal-report --work-root Engineering_Study/exercises/build/learner-g2-formal-work --cmake $StudyCMake --ninja $StudyNinja --samples 5 --warmups 1 --seed 20260908 --parallel 1 --timeout 180
```
