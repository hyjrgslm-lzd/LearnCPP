...
```powershell
cmake -S Engineering_Study/exercises/F2_dependencies -B Engineering_Study/exercises/build/learner-f2-source -G Ninja -DCMAKE_BUILD_TYPE=Release
cmake --build Engineering_Study/exercises/build/learner-f2-source --verbose
ctest --test-dir Engineering_Study/exercises/build/learner-f2-source --output-on-failure
```
...
```powershell
$prefix = Join-Path (Get-Location).Path 'Engineering_Study/exercises/build/learner-f2-prefix'
cmake -S Engineering_Study/exercises/F2_dependencies/provider_fixture -B Engineering_Study/exercises/build/learner-f2-provider -G Ninja -DCMAKE_BUILD_TYPE=Release
cmake --build Engineering_Study/exercises/build/learner-f2-provider
cmake --install Engineering_Study/exercises/build/learner-f2-provider --prefix "$prefix"
cmake -S Engineering_Study/exercises/F2_dependencies -B Engineering_Study/exercises/build/learner-f2-installed -G Ninja -DCMAKE_BUILD_TYPE=Release -DF2_DEPENDENCY_MODE=find_package "-DCMAKE_PREFIX_PATH=$prefix"
cmake --build Engineering_Study/exercises/build/learner-f2-installed --verbose
ctest --test-dir Engineering_Study/exercises/build/learner-f2-installed --output-on-failure
```
...
```powershell
cmake -S Engineering_Study/exercises/F2_dependencies -B Engineering_Study/exercises/build/learner-f2-student -G Ninja -DCMAKE_BUILD_TYPE=Release -DENGINEERING_STUDY_TEST_STUDENTS=ON
cmake --build Engineering_Study/exercises/build/learner-f2-student
ctest --test-dir Engineering_Study/exercises/build/learner-f2-student -L student --output-on-failure
```
