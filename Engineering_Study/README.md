...
- [Concurrency](../Concurrency_Study/README.md)主讲同步、发布与回收；本课为其 CMake 配置、编译器/库能力探测、Release 检查和诊断提供工程先修。
- [Coroutine](../Coroutine_Study/README.md)主讲协议与生命周期；本课的 ABI、符号和优化观察衔接 J2/F3，依赖管理衔接真实 I/O 与 sender 桥接。
