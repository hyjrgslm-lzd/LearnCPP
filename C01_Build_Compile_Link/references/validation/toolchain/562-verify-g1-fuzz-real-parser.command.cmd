...
"%PYTHON%" "%ROOT%\Engineering_Study\exercises\G1_diagnostics\scripts\verify_fuzz.py" --output "%ROOT%\Engineering_Study\references\validation\toolchain\g1-r2-fuzz-real-parser"
exit /b %errorlevel%
