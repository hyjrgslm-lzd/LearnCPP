...
set OUT=%ROOT%\Engineering_Study\references\validation\toolchain\g2-r3b-subset-smoke
set WORK=%ROOT%\Engineering_Study\exercises\build\g2-r3b-subset-smoke-work
