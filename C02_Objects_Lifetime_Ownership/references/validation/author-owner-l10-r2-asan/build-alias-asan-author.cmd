...
set "OUT=build\c02-owner-l10-r2-asan"
...
clang-cl /nologo /std:c++20 /EHsc /Od /Zi /fsanitize=address /MDd /I "%REF%" /I "%SUP%" "%SRC%\alias-copy-uaf.cpp" /Fe:"%OUT%\alias-copy-uaf.exe"
if errorlevel 1 exit /b %errorlevel%
clang-cl /nologo /std:c++20 /EHsc /Od /Zi /fsanitize=address /MDd /I "%REF%" /I "%SUP%" "%SRC%\alias-move-uaf.cpp" /Fe:"%OUT%\alias-move-uaf.exe"
exit /b %errorlevel%
