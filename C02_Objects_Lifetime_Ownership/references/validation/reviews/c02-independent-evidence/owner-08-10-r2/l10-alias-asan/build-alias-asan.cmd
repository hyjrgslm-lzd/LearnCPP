...
clang-cl --version
if errorlevel 1 exit /b %errorlevel%
set "OUT=Core_Study\references\validation\reviews\c02-independent-evidence\owner-08-10-r2\l10-alias-asan"
...
clang-cl /nologo /std:c++20 /EHsc /Od /Zi /fsanitize=address /MD /I "%REF%" /I "%SUP%" "%OUT%\alias-copy-uaf.cpp" /Fe:"%OUT%\alias-copy-uaf.exe"
if errorlevel 1 exit /b %errorlevel%
clang-cl /nologo /std:c++20 /EHsc /Od /Zi /fsanitize=address /MD /I "%REF%" /I "%SUP%" "%OUT%\alias-move-uaf.cpp" /Fe:"%OUT%\alias-move-uaf.exe"
exit /b %errorlevel%
