...
src="/root/learncpp-c08-builds/tsan-r3-src-20260910-1745"
build_plain="/root/learncpp-c08-builds/tsan-r3-plain-20260910-1745"
build_tsan="/root/learncpp-c08-builds/tsan-r3-tsan-20260910-1745"
report="/mnt/f/CPPTrain/LearnCPP/C08_Concurrency/references/validation/c08-revision/tsan-diagnosis/r3-run-20260910-1745"
...
/usr/bin/timeout 15 "$build_tsan/runtime_tests/runtime_scheduling_test" > "$report/tsan-direct-scheduling.txt" 2>&1
printf '%s\n' "$?" > "$report/status-tsan-direct-scheduling.txt"
