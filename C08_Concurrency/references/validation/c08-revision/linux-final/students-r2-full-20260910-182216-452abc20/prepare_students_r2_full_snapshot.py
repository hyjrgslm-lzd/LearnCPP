...
ROOT = REPO / "C08_Concurrency"
EXCLUDE_DIRS = {".git", ".omx", ".codex", ".agents", ".omc", ".claude", ".vs", "_deps", "CMakeFiles", "__pycache__", ".cache"}
...
def main() -> int:
    ...
    summary = {
        ...
        "verifyStudentsSha256": sha(ROOT / "exercises" / "tools" / "verify_students.py"),
